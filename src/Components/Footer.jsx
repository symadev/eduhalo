        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 mb-8 sm:mb-12">
          ...
          <div className="mt-6 sm:mt-0">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li><a href="/" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Home</a></li>
              <li><a href="/templates" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Templates</a></li>
              <li><a href="/builder" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Resume Builder</a></li>
              <li><a href="/cover-letter" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Cover Letter</a></li>
              <li><a href="/blog" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Blog</a></li>
              <li><a href="/contact" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Contact</a></li>
            </ul>
          </div>
          ...
          <div className="mt-6 sm:mt-0">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li><a href="/" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">ATS-Friendly Templates</a></li>
              <li><a href="/" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">PDF Download</a></li>
              <li><a href="/" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Custom Design</a></li>
              <li><a href="/" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Real-time Preview</a></li>
              <li><a href="/" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Skills Optimizer</a></li>
              <li><a href="/" className="text-gray-600 hover:text-pink-600 transition-colors duration-300 text-sm sm:text-base hover:font-medium">Multiple Formats</a></li>
            </ul>
          </div>
